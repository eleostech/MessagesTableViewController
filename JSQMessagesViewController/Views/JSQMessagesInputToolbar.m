...
- (void)awakeFromNib
{
    ...
    NSBundle *bundle = [NSBundle bundleForClass:[JSQMessagesToolbarContentView class]];
    NSArray *nibViews = [bundle loadNibNamed:NSStringFromClass([JSQMessagesToolbarContentView class]) owner:nil options:nil];
